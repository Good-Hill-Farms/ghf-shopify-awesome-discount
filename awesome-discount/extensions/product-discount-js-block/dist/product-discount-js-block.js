(() => {
  ...
  // extensions/product-discount-js-block/src/DiscountFunctionSettings.jsx
  var import_react21 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var TARGET = "admin.discount-details.function-settings.render";
  var DEFAULT_BUY_X_GET_Y = {
    buyQuantity: 2,
    getQuantity: 1,
    discountPercentage: 100,
    // 100% discount means free item
    enabled: true
  };
  var MAX_TAG_DISCOUNT = 100;
  var MAX_DISCOUNT_PERCENTAGE = 100;
  function BuyXGetYDiscountManager({ buyXGetY, setBuyXGetY }) {
    const handleBuyQuantityChange = (newValue) => {
      setBuyXGetY(__spreadProps(__spreadValues({}, buyXGetY), { buyQuantity: newValue }));
    };
    const handleGetQuantityChange = (newValue) => {
      setBuyXGetY(__spreadProps(__spreadValues({}, buyXGetY), { getQuantity: newValue }));
    };
    const handleDiscountPercentageChange = (newValue) => {
      setBuyXGetY(__spreadProps(__spreadValues({}, buyXGetY), { discountPercentage: newValue }));
    };
    const handleToggleEnabled = () => {
      setBuyXGetY(__spreadProps(__spreadValues({}, buyXGetY), { enabled: !buyXGetY.enabled }));
    };
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { background: "surface", border: "base", borderRadius: "base", padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: "base", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { blockAlignment: "center", inlineAlignment: "space-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { variant: "headingMd", children: "Buy X Get Y Discount" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          Button2,
          {
            variant: buyXGetY.enabled ? "primary" : "secondary",
            onPress: handleToggleEnabled,
            children: buyXGetY.enabled ? "Enabled" : "Disabled"
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Configure your Buy X Get Y discount:" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Banner2, { tone: "info", children: [
        "When customers buy ",
        buyXGetY.buyQuantity,
        " items, they'll get ",
        buyXGetY.getQuantity,
        " additional item(s) at ",
        buyXGetY.discountPercentage,
        "% off.",
  ...
  function TagDiscountField({ tagId, tagName, percentage, onPercentageChange, onRemove }) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { blockAlignment: "center", inlineAlignment: "space-between", gap: "base", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        TextField2,
        {
          label: "Tag",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Button2,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Icon2, { source: "removeMajor" })
        }
      )
    ] }) });
  }
  var DiscountFunctionSettings_default = reactExtension(TARGET, () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(App, {}));
  function App() {
    var _a;
    const { applyMetafieldChange, query, data } = useApi(TARGET);
    const [loading, setLoading] = (0, import_react21.useState)(false);
    const [tagDiscounts, setTagDiscounts] = (0, import_react21.useState)([]);
    const [nextTagId, setNextTagId] = (0, import_react21.useState)(1);
    const [buyXGetY, setBuyXGetY] = (0, import_react21.useState)(__spreadValues({}, DEFAULT_BUY_X_GET_Y));
    const [availableTags, setAvailableTags] = (0, import_react21.useState)([]);
    const [selectedTag, setSelectedTag] = (0, import_react21.useState)("");
    ...
    (0, import_react21.useEffect)(() => {
      function fetchTags() {
        ...
        `);
            const allTags = ((_c = (_b = (_a2 = response == null ? void 0 : response.data) == null ? void 0 : _a2.customers) == null ? void 0 : _b.edges) == null ? void 0 : _c.reduce((acc, edge) => {
    ...
    (0, import_react21.useEffect)(() => {
      function loadInitialData() {
        return __async(this, null, function* () {
          var _a2, _b, _c, _d;
          if (!((_a2 = data == null ? void 0 : data.discountNode) == null ? void 0 : _a2.id)) return;
          try {
            const response = yield query(`
        ...
        `, {
            ...
            const savedConfig = (_d = (_c = (_b = response == null ? void 0 : response.data) == null ? void 0 : _b.discountNode) == null ? void 0 : _c.metafield) == null ? void 0 : _d.value;
            if (savedConfig) {
              try {
            ...
            console.error("Error loading initial data:", error2);
            setError("Failed to load saved configuration");
          }
        });
      }
      loadInitialData();
    }, [query, (_a = data == null ? void 0 : data.discountNode) == null ? void 0 : _a.id]);
    const handleAddTag = () => {
    ...
    const handlePercentageChange = (tagId, newPercentage) => {
      ...
      setTagDiscounts(tagDiscounts.map(
        (td) => td.id === tagId ? __spreadProps(__spreadValues({}, td), { percentage: newPercentage }) : td
      ));
      setError("");
    };
    const handleSave = () => __async(this, null, function* () {
      try {
        ...
        const metafieldDefinition = yield getMetafieldDefinition(query);
        if (!metafieldDefinition) {
          yield createMetafieldDefinition(query);
        }
        yield applyMetafieldChange({
    ...
    const availableTagOptions = availableTags.filter((tag) => !tagDiscounts.find((td) => td.tagName === tag)).map((tag) => ({ label: tag, value: tag }));
    const totalTagDiscount = tagDiscounts.reduce((sum, td) => sum + td.percentage, 0);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FunctionSettings2, { onSave: handleSave, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Form2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: "base", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { background: "surface", border: "base", borderRadius: "base", padding: "none", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: "base", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: "base", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { variant: "headingMd", children: "Additional Tag-Based Discounts" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Banner2, { children: [
            "These discounts will be added on top of the Buy X Get Y discount. Maximum additional discount per tag: ",
            MAX_TAG_DISCOUNT,
            "%"
          ] }),
          error && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { tone: "critical", children: error })
        ] }) }),
        loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { gap: "base", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ProgressIndicator2, {}),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Loading tags..." })
        ] }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: "none", children: [
          tagDiscounts.map(({ id, tagName, percentage }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            TagDiscountField,
            {
              tagId: id,
              tagName,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { blockAlignment: "center", gap: "base", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Select2,
              {
                label: "Select a tag",
          ...
          availableTags.length === 0 && !loading && !error && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { tone: "subdued", children: "No customer tags found. Add tags to customers to use them for discounts." }) }),
          tagDiscounts.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Banner2, { tone: "info", children: [
            "Total additional discount from tags: ",
            totalTagDiscount,
            "%"
          ] }) })
        ] })
  ...
  function getMetafieldDefinition(adminApiQuery) {
    return __async(this, null, function* () {
      var _a, _b;
      try {
        const response = yield adminApiQuery(`
    ...
    `);
        const definition = (_b = (_a = response.data) == null ? void 0 : _a.metafieldDefinitions) == null ? void 0 : _b.nodes[0];
  ...
  function createMetafieldDefinition(adminApiQuery) {
    return __async(this, null, function* () {
      var _a, _b;
      try {
        const response = yield adminApiQuery(`
    ...
    `);
        const result = (_a = response.data) == null ? void 0 : _a.metafieldDefinitionCreate;
        ...
        console.log("Created metafield definition:", result == null ? void 0 : result.createdDefinition);
        return result == null ? void 0 : result.createdDefinition;
      } catch (error) {
...
//# sourceMappingURL=product-discount-js-block.js.map
